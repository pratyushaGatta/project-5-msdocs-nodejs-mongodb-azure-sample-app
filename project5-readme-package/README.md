...
![Azure resources](docs/screenshots/04-azure-resources.png)
...
![Terraform project files](docs/screenshots/02-terraform-files.png)
...
![Successful Terraform apply](docs/screenshots/03-terraform-apply-success.png)

## Local Application Validation

![Local Todo application](docs/screenshots/01-local-application.png)
...
![Jenkins service running](docs/screenshots/06-jenkins-service.png)

![Jenkins dashboard](docs/screenshots/07-jenkins-dashboard.png)
...
![Azure Service Principal creation](docs/screenshots/05-service-principal.png)
...
![Successful Jenkins CD pipeline](docs/screenshots/08-cd-pipeline-success.png)

![Application deployed to Azure App Service](docs/screenshots/09-deployed-azure-app.png)
